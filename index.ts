...
const COLD_MEMORY_PROMPT_HINT = `\n\n[ПАМЯТЬ]\nУ тебя есть архив (векторная база). Автономно ищи в нём (search_cold_memory) при нехватке прошлых знаний. Сохраняй туда (save_to_cold_memory) важные итоги. Удаляй (delete_from_cold_memory) только зная точный ID после поиска.`;
