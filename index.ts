...
2. ЗАПИСЬ (save_to_cold_memory): Сохраняй всё, что имеет долгосрочную ценность: технические решения, детали биографии юзера, лор игр, важные инсайты. 
   ...
   - Правило тегов (source): ОБЯЗАТЕЛЬНО ВСЕГДА указывай текущую дату в формате [ГГГГ-ММ-ДД], либо ту, которую {{user}} попросил напрямую, а также краткое название (напр. "[2026-04-18] Прогулка с Верой"). ДАТА ДОЛЖНА БЫТЬ ВСЕГДА.
