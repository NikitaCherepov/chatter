  ...
  const handleSend = useCallback(async () => {
    ...
    await api.streamChatMessage(
      ...
      },
      {
        ...
        preferredModel,
        dice_mode: diceMode,
        // Rooms: the message is always saved without a direct assistant reply.
        // The SERVER runs the response queue (auto / @mentions) and broadcasts
        // room_agent_* events to every participant.
        ...(roomCreated ? { userOnly: true } : {}),
      },
