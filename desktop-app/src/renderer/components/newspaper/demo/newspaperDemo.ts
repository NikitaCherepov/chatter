...
export const DEMO_NEWSPAPER_ISSUE: NewspaperIssue = {
  ...
  document: {
    ...
    blocks: [
      ...
      { id: 'article-data', type: 'article', role: 'standard', title: 'Данные важнее красивого снимка', text: 'За каждым изображением скрываются спектры, измерения и месяцы проверки. Хорошая научная история показывает не только результат, но и путь к нему.', sources: [{ title: 'NASA Data', url: 'https://data.nasa.gov/' }] },
