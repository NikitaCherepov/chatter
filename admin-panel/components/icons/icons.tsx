...
export type IconName = 'overview' | 'users' | 'models' | 'limits' | 'integrations' | 'services' | 'system' | 'logs' | 'security' | 'logout' | 'refresh' | 'arrow';

const paths: Record<IconName, ReactNode> = {
  overview: <><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></>,
  users: <><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/></>,
  models: <><path d="M12 2 3 7l9 5 9-5-9-5Z"/><path d="m3 12 9 5 9-5M3 17l9 5 9-5"/></>,
  limits: <><path d="M4 19V9M10 19V5M16 19v-7M22 19H2"/></>,
  integrations: <><path d="M8 12h8M12 8v8"/><path d="M7 2h10v5a5 5 0 0 1-10 0V2ZM7 22h10v-5a5 5 0 0 0-10 0v5Z"/></>,
  ...
  logs: <><path d="M4 4h16v16H4zM8 9l2 2-2 2M13 13h3"/></>,
