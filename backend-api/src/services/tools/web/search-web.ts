...
export const searchWebTool: Tool = {
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          search_type: { type: 'string', enum: ['web', 'news', 'images'], description: 'Search regular web pages, news, or images. Image results include direct image URLs and their source pages. Defaults to web.', default: 'web' },
  ...
  handler: async (args, context) => {
    ...
    return runWebSearch(query, {
      ...
      searchType: args.search_type === 'news' ? 'news' : args.search_type === 'images' ? 'images' : 'web',
