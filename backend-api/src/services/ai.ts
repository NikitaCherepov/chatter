...
const buildDescribeImageTool = () => {
  return {
    ...
    function: {
      name: 'describe_image',
      description: `Отправляет изображение(я) в vision-модель для анализа. Работает с любыми изображениями в чате.

Источники изображений:
- Фотографии, прикреплённые пользователем (маркеры [Прикреплено изображение N: URL])
- Скриншоты и сгенерированные картинки (маркеры [Generated image N: URL])
...
- Нужно проанализировать скриншот или сгенерированную картинку из истории чата

В параметре question укажи чёткую задачу для vision-модели.
В параметре image_url укажи URL изображения (из маркеров [Прикреплено изображение N: URL] или [Generated image N: URL] в сообщениях), чтобы проанализировать конкретное изображение — в том числе из прошлых сообщений.
Если image_url не указан — анализируются изображения из текущего сообщения пользователя.
В ответ получишь текстовое описание/анализ от vision-модели.`,
      parameters: {
        ...
        properties: {
          ...
          image_url: {
            type: 'string',
            description: 'URL конкретного изображения (из маркера [Прикреплено изображение N: URL] или [Generated image N: URL]). Используй для анализа любого изображения из истории чата.'
          },
          image_index: {
            type: 'number',
