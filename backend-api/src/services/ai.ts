...
- Скриншоты и сгенерированные картинки (маркеры [Attached image N: URL])
...
В параметре image_url укажи URL изображения (из маркеров [Прикреплено изображение N: URL] или [Attached image N: URL] в сообщениях), чтобы проанализировать конкретное изображение — в том числе из прошлых сообщений.
...
В ответ получишь текстовое описание/анализ от vision-модели.`,
      parameters: {
        ...
        properties: {
          ...
          image_url: {
            type: 'string',
            description: 'URL конкретного изображения (из маркера [Прикреплено изображение N: URL] или [Attached image N: URL]). Используй для анализа любого изображения из истории чата.'
          },
          image_index: {
            type: 'number',
