/** Single source of truth for languages in webapp-notes.
 *  Add or remove a code here — the i18next config and the translation
 *  script pick it up automatically.  When adding a language, also add a
 *  matching static import in index.ts (Next.js bundler requires JSON
 *  imports to be statically analyzable). */
